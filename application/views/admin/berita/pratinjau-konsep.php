  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pratinjau Berita (Konsep)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('admin/home')?>">Home</a></li>
			  <li class="breadcrumb-item"><a href="<?= base_url('/admin/manajemen-berita/berita')?>">Berita</a></li>
			  <li class="breadcrumb-item"><a href="<?= base_url('/admin/manajemen-berita/berita/konsep')?>">Konsep</a></li>
              <li class="breadcrumb-item active">Pratinjau Berita (Konsep)</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-3 mb-4">
					<a class="btn btn-success" href="<?= base_url('/admin/manajemen-berita/berita/konsep')?>" role="button" title="Kembali">
