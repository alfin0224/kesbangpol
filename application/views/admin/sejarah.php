  		...
  		<div class="container-fluid">
  			...
  			<div class="card">
  				<div class="card-header">
  					...
  					<!-- <a class="btn btn-success" href="<?= base_url('admin/profil/sejarah/tambah')?>" role="button" title="Tambah Sejarah">
                <i class="fas fa-plus"> Tambah Sejarah</i>
              </a> -->
  				</div>
  				<!-- /.card-header -->
  				<div class="card-body">
						...
						<?php foreach($sejarah as $sejarah): ?>
  							<tr>
  								...
  								<td class="text-center">
  									<a class="btn btn-warning mb-1" href="<?= base_url('admin/profil/sejarah/ubah/'); echo encrypt_url($sejarah->id_sejarah); ?>" role="button"
  										title="Ubah">
  ...
  <!-- <div class="modal-header">
      <h5 class="modal-title text-center" id="myModal">Hapus Data Sejarah</h4>
