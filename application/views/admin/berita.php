  		...
  		<div class="container-fluid">
  			...
  			<div class="card">
  				<div class="card-header">
  					...
  					<a class="btn btn-success" href="<?= base_url('/admin/manajemen-berita/berita/tambah')?>" role="button"
  						title="Tambah Berita">
  						<i class="fas fa-plus"> Tambah Berita</i>
  					</a>

					<button class="btn btn-primary tooltip-delete" disabled="" title="Berita Publikasi"><i class="fas fa-file-upload"> Berita (Publikasi)</i></button>

  					<a class="btn btn-warning" href="<?= base_url('/admin/manajemen-berita/berita/konsep')?>" role="button"
  						title="Konsep">
  						<i class="fas fa-clipboard-list"> Konsep</i>
  					</a>
  					<a class="btn btn-danger" href="<?= base_url('/admin/manajemen-berita/berita/tong-sampah')?>" role="button"
  						title="Tong Sampah">
                			...
                			foreach ($berita as $b) { ?>
  							<tr>
								...
								echo date_format($date, "d-M-Y H:i:s"); ?></td>
  								<td class="text-center">
								  	<a class="btn btn-primary mb-1" href="<?= base_url('/admin/manajemen-berita/berita/pratinjau/'); echo encrypt_url($b->id_berita); ?>" role="button" title="Pratinjau">
